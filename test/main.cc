...
int main() {
	...
	// Loading a LUA file.
	luadata::luadata test("mydata.lua");

	/*
	float floating_value = test["floating_value"];
	std::cout << "floating_value: " << floating_value << std::endl;

	double double_value = test["double_value"];
	...
	float nil_value_as_float = test["nil_value"];
	...
	std::cout << "                " << nil_value_as_float << " (as float)" << std::endl;
